...
cataloglink='https://catalogs.northwestern.edu/undergraduate/courses-az/'
...
def scrapecatalog():
    ...
    uls=atozdiv.select('div:not(.azMenu) ul')
    for ul in uls:
        if ul.find_parent('div', class_='azMenu'):
            continue
        lis=ul.select('li')
        for li in lis:
            ...
            if atag:
                ...
                departmentlink=f'https://catalogs.northwestern.edu/{departmentlink}'
